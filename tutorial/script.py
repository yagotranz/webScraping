...
class BancaMarch(Spider):
	...
	def parse(self, response):
		yield FormRequest.from_response(response,formname='basic',formdata={'usuario': user,'clave': password},callback=self.parse1)
